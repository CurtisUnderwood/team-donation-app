...
const MathQuiz: React.FC = () => {
  ...
  return (
    <div className="p-4 rounded-xl shadow-md w-1/4 mx-auto text-center">
      ...
      <div className="block">
        {question.options.map((option, index) => (
          <button
            key={index}
            className={`block my-4 mx-auto w-1/2 bg-${
              feedback === "Correct" && option === question.answer
                ? "green"
                : feedback === "Incorrect" && option === question.answer
                ? "red"
                : "white"
            } border-forest-green text-forest-green border-2 font-bold py-2 px-4 rounded-2xl hover:bg-forest-green hover:text-white`}
